...
public class CoinManager : MonoBehaviour
{
	...
	[SerializeField] private float displayCoinRaiseSpeed = 1f;
	...
	public IEnumerator DisplayRaiseCoin()
	{
		while (true)
		{
			...
			while (Time.time < endTime)
			{
				...
				displayCoin = Mathf.Lerp(startCoin, endCoin, (Time.time - startTime) / (endTime - startTime) * displayCoinRaiseSpeed);
